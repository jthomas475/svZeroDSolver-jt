...
/**
 * @file ValveBinary.h
 * @brief model::ValveBinary source file
 */
#ifndef SVZERODSOLVER_MODEL_ValveBinary_HPP_ // Not sure if I need to implement something directly for the HPP file?
#define SVZERODSOLVER_MODEL_ValveBinary_HPP_
 ...
 *
 */
class ValveBinary : public Block {
 public:
  /**
  ...
  /**
   * @brief Construct a new ValveBinary object
   *
   * @param id Global ID of the block
   * @param model The model to which the block belongs
   */
  ValveBinary(int id, Model* model)
      : Block(id, model, BlockType::valve_binary, BlockClass::valve,
              {{"Rmax", InputParameter()},
               {"Rmin", InputParameter()},
...
#endif  // SVZERODSOLVER_MODEL_ValveBinary_HPP_
