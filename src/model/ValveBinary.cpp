/*
Creating new valve block to implement binary open or closed behavior
*/
...
void ValveBinary::setup_dofs(DOFHandler& dofhandler) {
...
void ValveBinary::update_constant(SparseSystem& system,
